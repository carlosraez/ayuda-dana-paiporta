  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <Link href="/ayuda/necesito" className="transform hover:scale-102 transition-transform">
        ...
        <Link href="/ayuda/ofrezco" className="transform hover:scale-102 transition-transform">
